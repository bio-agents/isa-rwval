"""Tests on isaagents.model classes"""
...
class CommentTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Comment(name='', value='')",
                         repr(self.comment_default))
        self.assertEqual("isaagents.model.Comment(name='N', value='V')",
                         repr(self.comment))
...
class InvestigationTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Investigation(identifier='', "
        ...
        self.assertEqual("isaagents.model.Investigation(identifier='id', "
...
class OntologySourceTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.OntologySource(name='N', file='', "
                         "version='', description='', comments=[])",
                         repr(self.ontology_source_default))
        self.assertEqual("isaagents.model.OntologySource(name='N', file='F', "
...
class OntologyAnnotationTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.OntologyAnnotation(term='', "
                         "term_source=None, term_accession='', comments=[])",
                         repr(self.ontology_annotation_default))
        self.assertEqual("isaagents.model.OntologyAnnotation(term='T', "
                         "term_source=isaagents.model.OntologySource("
...
class PublicationTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Publication(pubmed_id='', "
                         "doi='', author_list='', title='', status=None, "
                         "comments=[])",
                         repr(self.publication_default))
        self.assertEqual("isaagents.model.Publication(pubmed_id='1', "
                         "doi='10', author_list='A. Author', title='T', "
                         "status=isaagents.model.OntologyAnnotation(term='S', "
                         "term_source=None, term_accession='', comments=[]), "
                         "comments=[])",
...
class PersonTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Person(last_name='', first_name='', "
                         "mid_initials='', email='', phone='', fax='', "
                         "address='', affiliation='', roles=[], comments=[])",
                         repr(self.person_default))
        self.assertEqual("isaagents.model.Person(last_name='L', first_name='F', "
                         "mid_initials='M', email='a@b.com', phone='0', "
                         "fax='1', address='A', affiliation='Af', "
                         "roles=[isaagents.model.OntologyAnnotation(term='R', "
                         "term_source=None, term_accession='', comments=[])], "
                         "comments=[])",
                         repr(self.person))
...
class StudyTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Study(filename='', "
        ...
        self.assertEqual("isaagents.model.Study(filename='file', "
...
class StudyFactorTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.StudyFactor(name='', "
                         "factor_type=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
                         "comments=[]), comments=[])",
                         repr(self.factor_default))
        self.assertEqual("isaagents.model.StudyFactor(name='N', "
                         "factor_type=isaagents.model.OntologyAnnotation("
...
class CharacteristicTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Characteristic("
                         "category=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
                         "comments=[]), "
                         "value=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
        ...
        self.assertEqual("isaagents.model.Characteristic("
                         ...
                         "comments=[]), value=0, "
                         "unit=isaagents.model.OntologyAnnotation(term='U', "
                         "term_source=None, term_accession='', comments=[]), "
...
class AssayTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Assay(measurement_type="
                         "isaagents.model.OntologyAnnotation(term='', "
                         "term_source=None, term_accession='', comments=[]), "
                         "technology_type=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
        ...
        self.assertEqual("isaagents.model.Assay(measurement_type="
                         "isaagents.model.OntologyAnnotation(term='MT', "
                         "term_source=None, term_accession='', comments=[]), "
                         "technology_type=isaagents.model.OntologyAnnotation("
...
class ProtocolTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Protocol(name='', "
                         "protocol_type=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
                         "comments=[]), uri='', version='', parameters=[], "
                         "components=[], comments=[])",
                         repr(self.protocol_default))
        self.assertEqual("isaagents.model.Protocol(name='N', "
                         "protocol_type=isaagents.model.OntologyAnnotation("
...
class ProtocolParameterTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.ProtocolParameter("
                         "parameter_name=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
                         "comments=[]), comments=[])",
...
class ParameterValueTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.ParameterValue(category=None, "
                         "value=None, unit=None, comments=[])",
                         repr(self.parameter_value_default))
        self.assertEqual("isaagents.model.ParameterValue("
                         "category=isaagents.model.ProtocolParameter("
                         "parameter_name=isaagents.model.OntologyAnnotation("
                         "term='P', term_source=None, term_accession='', "
                         "comments=[]), comments=[]), value=0, "
                         "unit=isaagents.model.OntologyAnnotation("
...
class ProtocolComponentTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.ProtocolComponent(name='', "
                         "category=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
                         "comments=[]), comments=[])",
                         repr(self.component_default))
        self.assertEqual("isaagents.model.ProtocolComponent(name='C', "
                         "category=isaagents.model.OntologyAnnotation("
...
class SourceTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Source(name='', characteristics=[], "
                         "comments=[])",
                         repr(self.source_default))
        self.assertEqual("isaagents.model.Source(name='S', characteristics=[], "
                         "comments=[])",
                         repr(self.source))
...
class SampleTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Sample(name='', characteristics=[], "
                         "factor_values=[], derives_from=[], comments=[])",
                         repr(self.sample_default))
        self.assertEqual("isaagents.model.Sample(name='S', characteristics=[], "
                         "factor_values=[], derives_from=[], comments=[])",
                         repr(self.sample))
...
class ExtractTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.Extract(name='', type='Extract Name', "
                         "characteristics=[], comments=[])",
                         repr(self.extract_default))
        self.assertEqual("isaagents.model.Extract(name='E', "
...
class LabeledExtractTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.LabeledExtract(name='', "
                         "type='Labeled Extract Name', characteristics=[], "
                         "comments=[])", repr(self.labeled_extract_default))
        self.assertEqual("isaagents.model.LabeledExtract(name='E', "
                         "type='Labeled Extract Name', characteristics=[], "
...
class FactorValueTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.FactorValue(factor_name=None, "
                         "value=None, unit=None)",
                         repr(self.factor_value_default))
        self.assertEqual("isaagents.model.FactorValue("
                         "factor_name=isaagents.model.StudyFactor(name='F', "
                         "factor_type=isaagents.model.OntologyAnnotation("
                         "term='', term_source=None, term_accession='', "
                         "comments=[]), comments=[]), value=0, "
                         "unit=isaagents.model.OntologyAnnotation(term='U', "
...
class DataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.DataFile(filename='', label='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.DataFile(filename='file', "
...
class RawDataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.RawDataFile(filename='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.RawDataFile(filename='file', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file))
...
class DerivedDataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.DerivedDataFile(filename='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.DerivedDataFile(filename='file', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file))
...
class RawSpectralDataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.RawSpectralDataFile(filename='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.RawSpectralDataFile(filename='file', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file))
...
class ArrayDataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.ArrayDataFile(filename='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.ArrayDataFile(filename='file', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file))
...
class DerivedSpectralDataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.DerivedSpectralDataFile(filename='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.DerivedSpectralDataFile("
...
class ProteinAssignmentFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.ProteinAssignmentFile(filename='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.ProteinAssignmentFile("
                         "filename='file', generated_from=[], comments=[])",
                         repr(self.data_file))
...
class PeptideAssignmentFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.PeptideAssignmentFile(filename='', "
                         "generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.PeptideAssignmentFile("
                         "filename='file', generated_from=[], comments=[])",
                         repr(self.data_file))
...
class DerivedArrayDataMatrixFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.DerivedArrayDataMatrixFile("
...
class PostTranslationalModificationAssignmentFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model."
...
class AcquisitionParameterDataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.AcquisitionParameterDataFile("
                         "filename='', generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.AcquisitionParameterDataFile("
                         "filename='file', generated_from=[], comments=[])",
...
class FreeInductionDecayDataFileTest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual("isaagents.model.FreeInductionDecayDataFile("
                         "filename='', generated_from=[], comments=[])",
                         repr(self.data_file_default))
        self.assertEqual("isaagents.model.FreeInductionDecayDataFile("
                         "filename='file', generated_from=[], comments=[])",

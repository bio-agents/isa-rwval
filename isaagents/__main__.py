...
def main(argv=None):
    """Run **isaagents** from the command line

    Arguments
        argv (list, optional): the list of arguments to run isaagents
    ...
    #                             usage='isaagents -c COMMAND [options]',
    #                             )
    #
    # p.add_argument('-c', dest='cmd', help='isaagents API command to run', required=True,
    ...
    # p.add_argument('--version', action='version', version='isaagents {}'.format("0.7"))

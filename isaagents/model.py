...
from isaagents.errors import ISAModelAttributeError
...
class Comment(object):
    ...
    def __repr__(self):
        return "isaagents.model.Comment(name='{comment.name}', " \
...
class Investigation(Commentable, MetadataMixin, object):
    ...
    def __repr__(self):
        return "isaagents.model.Investigation(" \
...
class OntologySource(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.OntologySource(name='{ontology_source.name}', " \
...
class OntologyAnnotation(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.OntologyAnnotation(" \
...
class Publication(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.Publication(" \
...
class Person(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.Person(last_name='{person.last_name}', " \
...
class Study(Commentable, StudyAssayMixin, MetadataMixin, object):
    ...
    def __repr__(self):
        return "isaagents.model.Study(filename='{study.filename}', " \
...
class StudyFactor(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.StudyFactor(name='{study_factor.name}', " \
...
class Assay(Commentable, StudyAssayMixin, object):
    ...
    def __repr__(self):
        return "isaagents.model.Assay(measurement_type={measurement_type}, " \
...
class Protocol(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.Protocol(name='{protocol.name}', " \
...
class ProtocolParameter(Commentable):
    ...
    def __repr__(self):
        return 'isaagents.model.ProtocolParameter(' \
...
class ParameterValue(Commentable):
    ...
    def __repr__(self):
        return 'isaagents.model.ParameterValue(category={category}, ' \
...
class ProtocolComponent(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.ProtocolComponent(name='{component.name}', " \
...
class Source(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.Source(name='{source.name}', " \
               "characteristics={source.characteristics}, " \
...
class Characteristic(Commentable):
    ...
    def __repr__(self):
        return 'isaagents.model.Characteristic(' \
...
class Sample(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.Sample(name='{sample.name}', " \
...
class Extract(Material):
    ...
    def __repr__(self):
        return "isaagents.model.Extract(name='{extract.name}', " \
               "type='{extract.type}', " \
...
class LabeledExtract(Material):
    ...
    def __repr__(self):
        return "isaagents.model.LabeledExtract(name='{labeled_extract.name}', " \
...
class FactorValue(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.FactorValue(factor_name={factor_name}, " \
...
class DataFile(Commentable):
    ...
    def __repr__(self):
        return "isaagents.model.DataFile(filename='{data_file.filename}', " \
...
class RawDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.RawDataFile(filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
...
class DerivedDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.DerivedDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class RawSpectralDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.RawSpectralDataFile(filename='{0.filename}', " \
...
class DerivedArrayDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.DerivedArrayDataFile(" \
               "filename='{data_file.filename}' " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class ArrayDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.ArrayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class DerivedSpectralDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.DerivedSpectralDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class ProteinAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.ProteinAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class PeptideAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.PeptideAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class DerivedArrayDataMatrixFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.DerivedArrayDataMatrixFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class PostTranslationalModificationAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.PostTranslationalModificationAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class AcquisitionParameterDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.AcquisitionParameterDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class FreeInductionDecayDataFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.FreeInductionDecayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class MetaboliteAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "isaagents.model.MetaboliteAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
